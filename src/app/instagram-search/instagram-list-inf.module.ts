...
@NgModule({
    imports: [CommonModule, RouterModule.forChild(InstagramListInfRoutes),ReactiveFormsModule,SliderModule,DataTableModule,InlineEditorModule,OverlayPanelModule,DialogModule,FormsModule,RoundpipeModule,NgPipesModule],
