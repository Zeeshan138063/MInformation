...
export class HeaderComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(private router: Router, private socket: ServerSocket, private _pushNotifications: PushNotificationsService, private http: HttpService, private data: DataService) {
    ...
    notify(body) {
        ...
        let notify = this._pushNotifications.create('InfluExp', options).subscribe( //creates a notification
            ...
            // res => console.log(res.event.type),
            // // res => console.log(res.event),
            // err => console.log(err)
        );
        // console.log(notify);
    }
    ...
    ngOnInit() {
        ...
        this.socketSubscription = this.socket.outputStream.subscribe((message: any) => {
            ...
            if (message['replay_channel']) {

                // alert(message['replay_channel']);
                localStorage.setItem('replay_channel', message['replay_channel']);
                this.currentUser = JSON.parse(localStorage.getItem('currentUser'));
            }
            if (message['notify']) {
                console.log(message['msg']);
                this.notify(message);
                // let temp = this.notifications['notifications'];
                // this.notifications['notifications'] = [{msg: 'Welcome!', created_at: Date.now()}];
                ...
                this.notification_class = 'header-alarm dropdown-toggle active';
